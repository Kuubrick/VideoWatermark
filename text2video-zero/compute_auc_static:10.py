...
def image_distortion(img1, img2, seed, args):
    ...
    if args.jpeg_ratio is not None:
        img1.save(f"tmp_{args.jpeg_ratio}_static:10.jpg", quality=args.jpeg_ratio)
        img1 = Image.open(f"tmp_{args.jpeg_ratio}_static:10.jpg")
        img2.save(f"tmp_{args.jpeg_ratio}_static:10.jpg", quality=args.jpeg_ratio)
        img2 = Image.open(f"tmp_{args.jpeg_ratio}_static:10.jpg")
...
parser.add_argument(
    "--orig_img_no_w_path",
    default="../datas/videos/text2video-zero/static_radius:10/8frames_uniform",
    type=str,
)
parser.add_argument(
    "--orig_img_w_path",
    default="../datas/videos/text2video-zero/static_radius:10/8frames_uniform_w",
    type=str,
)
...
# plt.savefig('/root/VideoWatermark/img_static:10_no_distortion.png')
# plt.show()
...
#          horizontalalignment='center', verticalalignment='bottom', transform=plt.gca().transAxes)
# plt.legend(loc='lower right')
# plt.savefig('/root/VideoWatermark/video_static:10_no_distortion.png')
# plt.show()
...
#          horizontalalignment='center', verticalalignment='bottom', transform=plt.gca().transAxes)
# plt.legend(loc='lower right')
# plt.savefig('/root/VideoWatermark/img_static:10_jpeg.png')
# plt.show()
...
#          horizontalalignment='center', verticalalignment='bottom', transform=plt.gca().transAxes)
# plt.legend(loc='lower right')
# plt.savefig('/root/VideoWatermark/video_static:10_jpeg.png')
# plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_static:10_crop.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_static:10_crop.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_static:10_rotate.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_static:10_rotate.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_static:10_gaussian_blur.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_static:10_gaussian_blur.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_static:10_gaussian_std.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_static:10_gaussian_std.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_static:10_bright.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_static:10_bright.png")
plt.show()
