...
parser.add_argument(
    "--orig_img_no_w_path",
    default="../datas/videos/text2video-zero/dynamic_radius/8frames_uniform",
    type=str,
)
parser.add_argument(
    "--orig_img_w_path",
    default="../datas/videos/text2video-zero/dynamic_radius/8frames_uniform_w",
    type=str,
)
parser.add_argument(
    "--radius_path",
    default="../datas/videos/text2video-zero/dynamic_radius/test/radius",
    type=str,
)
...
# plt.savefig('/root/VideoWatermark/img_dynamic_no_distortion.png')
# plt.show()
...
# plt.legend(loc='lower right')
# plt.show()
# plt.savefig('/root/VideoWatermark/video_dynamic_no_distortion.png')
...
#          horizontalalignment='center', verticalalignment='bottom', transform=plt.gca().transAxes)
# plt.legend(loc='lower right')
# plt.savefig('/root/VideoWatermark/img_dynamic_jpeg.png')
# plt.show()
...
#          horizontalalignment='center', verticalalignment='bottom', transform=plt.gca().transAxes)
# plt.legend(loc='lower right')
# plt.savefig('/root/VideoWatermark/video_dynamic_jpeg.png')
# plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_dynamic_crop.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_dynamic_crop.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_dynamic_rotate.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_dynamic_rotate.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_dynamic_gaussian_blur.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_dynamic_gaussian_blur.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_dynamic_gaussian_std.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_dynamic_gaussian_std.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/img_dynamic_bright.png")
plt.show()
...
plt.legend(loc="lower right")
plt.savefig("/root/VideoWatermark/video_dynamic_bright.png")
plt.show()
