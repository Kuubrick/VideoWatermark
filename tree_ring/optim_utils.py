...
def image_distortion(img1, img2, seed, args):
    ...
    if args.jpeg_ratio is not None:
        img1.save(f"tmp_{args.jpeg_ratio}.jpg", quality=args.jpeg_ratio)
        img1 = Image.open(f"tmp_{args.jpeg_ratio}.jpg")
        img2.save(f"tmp_{args.jpeg_ratio}.jpg", quality=args.jpeg_ratio)
        img2 = Image.open(f"tmp_{args.jpeg_ratio}.jpg")
